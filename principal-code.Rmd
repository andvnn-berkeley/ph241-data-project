...
diabetesfinal1 <- diabetes_clean2 %>% select(
  readmit_yesno, a_glucosidase.inhibitor, biguanide, hormone, diuretic, ddp4.inhibitor, meglitinide,
  sulfonylureas, glitazone, combo, race, diagnosis, time_in_hospital, num_medications, dischargestatus,
  admissionsource, age, gender)

diabetesfinal2 <- diabetes_clean3 %>% select(
  readmit_30days, a_glucosidase.inhibitor, biguanide, hormone, diuretic, ddp4.inhibitor, meglitinide,
  sulfonylureas, glitazone, combo, race, diagnosis, time_in_hospital, num_medications, dischargestatus,
  admissionsource, age, gender)
...
Running two logistic regression models blah blah write something here about running diagnostic tests

Assumptions to check for in a logistic regression:
...
note: had to delete diagnosis from model (missing values, need to deal with later)
